...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient.get(
              Uri.parse('${Env.BASE_URL}/movie/now_playing?${Env.API_KEY}')))
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
      ...
      // arrange
      when(mockHttpClient
              .get(Uri.parse('${Env.BASE_URL}/movie/popular?${Env.API_KEY}')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/movies/popular.json', ''), 200));
      // act
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockHttpClient
              .get(Uri.parse('${Env.BASE_URL}/movie/top_rated?${Env.API_KEY}')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/movies/top_rated.json', ''), 200));
      // act
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient
              .get(Uri.parse('${Env.BASE_URL}/movie/$tId?${Env.API_KEY}')))
          .thenAnswer((_) async => http.Response(
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse(
              '${Env.BASE_URL}/movie/$tId/recommendations?${Env.API_KEY}')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/movies/movie_recommendations.json', ''),
              200));
      // act
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse(
              '${Env.BASE_URL}/search/movie?${Env.API_KEY}&query=$tQuery')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/movies/search_spiderman_movie.json', ''),
              200));
      // act
